...
import logo_dark from '../../images/B.png';
                    ...
                    <nav id="nav-bar" className="navbar navbar-expand-lg fixed-top navbar-custom sticky sticky-dark">
                        <div className="container">
                            <Link className="logo text-uppercase" to="/">
                                ...
                                <img src={logo_dark} alt="" className="logo-dark" height="40" />
                            </Link>
                            ...
                            <div className={this.state.isOpenMenu ? "collapse navbar-collapse show" : "collapse navbar-collapse"} id="navbarCollapse">
                                ...
                                <ScrollspyNav
                                    scrollTargetIds={["home", "services", "portfolio","testimonial"]}
                                    ...
                                    <ul className="navbar-nav ml-auto navbar-center" id="mySidenav">
                                        ...
                                        <li className="nav-item">
                                            <a href="#testimonial" className="nav-link">Contact us</a>
                                        </li>
                                        
                                        {/* <li>
                                            <Link onClick={this.toggleModal} to="#" className="nav-link">Contact us</Link>
                                        </li> */}
                                    </ul>
                                </ScrollspyNav>
                            </div>
